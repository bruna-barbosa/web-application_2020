...
<?php
  ...
  //$user = mysql_real_escape_string($_POST['utilizador']);
  $user = ($_POST['utilizador']);
  //$hash = mysql_real_escape_string($_POST['confirmacao']);
  ...
  if( mysql_result($q, 0, 0) == "1" ){
    echo "os dados estão corretos: eliminar o pedido e permitir alterar a password";
