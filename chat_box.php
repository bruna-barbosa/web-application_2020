                        ...
                        <section class="chat-area">
                            <header>
                                <?php 
                                    ...
                                    if (isset($_SESSION['institutionLoggedIn']) && $_SESSION['institutionLoggedIn'] == true) {
                                        $sql = mysqli_query($conn, "SELECT * FROM V_voluntario WHERE username = '$user_id';");
                                    } else if ($_SESSION['volunteerLoggedIn'] == true or isset($_SESSION['volunteerLoggedIn']) && $_SESSION['institutionLoggedIn'] == false) {
                                        $sql = mysqli_query($conn, "SELECT * FROM V_instituicao WHERE username = '$user_id';");
                                    }
                                ...
                                <a href="chat_users.php" class="back-icon btn btn-primary">
                                    <i class="icon-arrow_back"></i> <!--tenho de trocar o icone porque não tenho licença pra este-->
                                </a>
                            ...
                            <form action="#" class="typing-area">
                                <input type="text" class="remetente" name="remetente" value="<?php echo $varray['username']; ?>" hidden>
                                <input type="text" class="destinatario" name="destinatario" value="<?php echo $user_id; ?>" hidden>
                                <input type="text" class="input-field" name="msg" placeholder="Escreva a sua mensagem..." >
                                
                                <button class="btn btn-primary">
                                    <i class="icon-send-o"></i> <!--tenho de trocar o icone porque não tenho licença pra este-->
                                </button>
                            </form>
                            <p id="teste">
                            </p>
