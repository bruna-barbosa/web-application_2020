                        ...
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <?php
                                    ...
                                    // Botão para Área Privada da Instituição - Caso Instituição esteja Logged In
                                        if (isset($_SESSION['institutionLoggedIn']) && $_SESSION['institutionLoggedIn'] == true) {
                                            echo '<li><a href="inst_private.php" class="nav-link">Àrea Privada</a></li>';
                                        }
                                    ?>
                                    <?php
                                ...
                                if (isset($_SESSION['volunteerLoggedIn']) && $_SESSION['volunteerLoggedIn'] == true
                                    ...
                                    echo '<li><a href="chat_users.php" class="btn-secondary" id="log-nav">Chat</a></li>';
                                    }
                ...
                <div class="container">
                    <div class="row mb-5">
                      <div class="col-lg-7 mx-auto text-center">
                        <h2 class="mb-4 section-heading">Projetos para si!</h2>
                    ...
                    <div class="row">
                        ...
                        <!-- ZONA PARA APARECER A TABLEA COM OS PROJETOS QUE CORRSPONDEM AOS REQUISITOS DOS VOLUNTÁRIOS -->
                        <?php
                        // Caso voluntário esteja Logged In
                            if (isset($_SESSION['volunteerLoggedIn']) && $_SESSION['volunteerLoggedIn'] == true) {
                                include "vol_projects_table.php";
                            }
                        ?>
                    </div>
                </div>
