                ...
                <div class="row mb-5">
                    <div class="col-lg-5 ml-auto mx-auto text-center">
                        <p>
                            ...
                            echo '<h2 class="mb-4 section-heading">Projeto #'.$proj.'</h2>' ;

                            require_once "lib/nusoap.php";

                            $client = new nusoap_client(
                                'http://appserver-01.alunos.di.fc.ul.pt/~asw001/Projeto/VolCandAcao.php'
                            );
                            $error = $client->getError();
                            $result = $client->call('nomeclientes', array('nome' => $vol,
                                                                          'projeto' => $proj));	//handle errors
                            /*
                            echo "<h2>Pedido</h2>";
